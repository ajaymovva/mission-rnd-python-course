...
def test_numbers_arithmetic_operations():
    ...
    #>>> import math
    #>>> help(math.isclose)
    assert math.isclose(2.33, 7/3, abs_tol=1), "fix abs_tol so that this assert passes"
...
-all arithmentic operations in python 
-mainly in division and modulo exoressions,comparisions of float.
-type conversions from integer to other bases and all the bases to integer.
"""