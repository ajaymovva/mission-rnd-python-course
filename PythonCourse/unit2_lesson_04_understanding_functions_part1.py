...
def leastvowel(input):
    return(input.count('a')+input.count('e')+input.count('o')+input.count('i')+input.count('u'))


# new functions end

def get_word_with_least_vowels(inpu):
    """
...
def get_min_max_words(input):
    ...
    return(minnum(input),maxnum(input))
...
-declarations and defnition and caling of the functions and return type of the function.
-use of list in the function and behaviour of list in the function.
-returning more than one value from function using tuple.
"""