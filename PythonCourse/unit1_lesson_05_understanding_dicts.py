...
def test_valid_dictionary_keys():
    ...
    try:
        ...
        print("See me in pytest output1?", te, sep="\n") # observe the error message
        assert True
    ...
    try:
        ...
        print("See me in pytest output2?", te, sep="\n")  # observe the error message
    ...
    try:
        ...
        print("See me in pytest output3?", te, sep="\n")  # observe the error message
...
-creating dictionaries,accesing dictionaries and operations on lists.
-key and value operations in dictioaries and different ways of assigning key values.
-make dictionaries using zip methods and other methods.
"""
