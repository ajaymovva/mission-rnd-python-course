...
-declaration of global variables and local variables.
-scope of global and local variables in the function and use if global variables inthe function.
-exception handling in the variables how global and locals are using in the function calls.
"""
