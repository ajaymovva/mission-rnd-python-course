...
-behaviour of all the built in types in python in if condition.
-truth values of all built in types.
-differce in truth value and behaving in certain conditions.
"""
