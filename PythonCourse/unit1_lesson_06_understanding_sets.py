...
-creation of sets and difference in dict and set creation.
-operations in sets and how data accesed in sets.
-methods in sets and interconversion in sets.
"""
