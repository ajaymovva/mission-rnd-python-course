...
-tracing of exceptions in python
-handing of exceptions and handling of one exception in one function in another function
-use of else,finally,try and except in handling exceptions.
"""
