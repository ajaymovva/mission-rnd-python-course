...
def test_function_call_with_keyword_arguments():
    ...
    assert [30,20,10,4] == demo(30,second=20,third=10)  # is this allowed? correct and uncomment
...
-type of argumentes and assingning of arguments to parameters.
-the importance of arguments and key word arguents in accessing it.
-unpacking process of tuples and arguments in function call.
"""
