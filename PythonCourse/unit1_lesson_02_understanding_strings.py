...
-no of ways strings are created,and how to embedded one quote in another quote.
-string related operations in slicing,accssing all characters and concat operations etc.
-string formattiong and related methods and operarions.
"""
