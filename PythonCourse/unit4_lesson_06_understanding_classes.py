...
def test_classes_bound_and_unbound_methods():
    ...
    try:
        ...
        pass
    x=q1_push.__self__
    assert x == q1_push.__self__      #bound method, is associated with an instance
...
class Person:
    ...
    def get_bmi_result(self):
        x=(self.weight/(self.height * 0.3048)**2)
        if x < 18.5:
            return "underweight"
